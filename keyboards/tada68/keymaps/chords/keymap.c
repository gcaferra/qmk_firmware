...
[_BL] = KEYMAP_ANSI(
  ...
  TO(_COLEMAK), KC_LGUI,KC_LALT,                KC_SPC,                        KC_RALT,MO(_FL),KC_RCTRL, KC_LEFT,KC_DOWN,KC_RGHT),
...
[_FL] = KEYMAP_ANSI(
  ...
  _______,_______,_______,BL_DEC, BL_TOGG,BL_INC, _______,KC_VOLD,KC_VOLU,KC_MUTE,_______,KC_BTN1, KC_MS_U, KC_PGDN, \
  _______,_______,KC_BTN2,                 _______,               _______,_______,_______,KC_MS_L,KC_MS_D, KC_MS_R),
/* Keymap _COLEMAK: (Colemak Layer) Colemak base Layer
  ...
  TO(_BL), KC_LGUI,KC_LALT,                KC_SPC,                        KC_APP,MO(_COLEMAK_FL),KC_RCTRL, KC_LEFT,KC_DOWN,KC_RGHT),
/* Keymap _COLEMAK_FL: Colemak Function Layer
   ...
   * |      |<- |Dn | ->|   |   |   |   |   |   |   |   |        |PgUp|
   * |----------------------------------------------------------------|
   * |        |   |   |Bl-|BL |BL+|   |VU-|VU+|MUT|   |   McL|MsU|PgDn|
   * |----------------------------------------------------------------|
   * |    |    |    |                       |   |   |    |MsL|MsD|MsR |
   * `----------------------------------------------------------------'
   */
 [_COLEMAK_FL] = KEYMAP_ANSI(
  KC_GESC , KC_F1 ,KC_F2 , KC_F3 , KC_F4 , KC_F5  , KC_F6 , KC_F7 , KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_DEL, KC_GRV ,  \
  _______,_______, KC_UP,_______,_______, _______,_______,_______,_______,_______,_______,_______,_______, _______,KC_DEL, \
  _______,KC_LEFT,KC_DOWN,KC_RIGHT,_______,_______,_______,_______,_______,_______,_______,_______,        _______,KC_PGUP, \
