...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 /* Functions Layer
   ...
   */
	[PUNKT] = LAYOUT(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
		_______, _______, KC_TILD, KC_RBRC, KC_LBRC, _______, _______, _______, _______, _______, _______, _______, _______, _______,
		_______, _______, KC_GRV , KC_RPRN, KC_LPRN, _______, _______, _______, _______, _______, _______, _______, _______,
		_______,  KC_NO , KC_BSLS, KC_RCBR, KC_LCBR, _______, _______, _______, _______, _______, _______, _______, _______, KC_NO,
