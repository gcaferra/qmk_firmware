...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		KC_BSPC, LT(2, KC_A), ALT_T(KC_S), SFT_T(KC_D), CTL_T(KC_F), LGUI_T(KC_G), RGUI_T(KC_H), CTL_T(KC_J), SFT_T(KC_K), ALT_T(KC_L), KC_SCLN, LT(3,KC_QUOT), KC_ENT,
		KC_DISABLE, KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_DISABLE, KC_NO,
		KC_DISABLE, KC_DISABLE, KC_SPC, KC_NO, LT(1,KC_SPC), KC_NO, KC_NO, KC_DISABLE, KC_NO, KC_DISABLE, KC_DISABLE),
