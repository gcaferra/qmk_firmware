 ...
 /* Base Layer
   ...
   */
	[BASE] = LAYOUT(
		...
		KC_BSPC, _A, _S, _D, _F, KC_G, KC_H, _J, _K, _L, _SCLN, _QUO, KC_ENT,
 ...
 /* Functions Layer
   ...
   */
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
		...
		_______,  KC_NO , _______, _______, KC_RBRC, KC_LBRC, _______, _______, _______, _______, _______, _______, _______, KC_NO,
   ...
   */
	[PUNKTL] = LAYOUT(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
	_______, _______, KC_COLN, KC_GRV , KC_CIRC, _______, _______, _______, _______ , _______, _______, _______, _______, _______,
	_______, _______, KC_DQUO, KC_HASH, KC_BSLS, _______, _______, _______, _______, _______, _______, _______, _______,
	_______,  KC_NO , _______, _______, KC_PIPE, KC_TILD, _______, _______, _______, _______, _______, _______, _______, KC_NO,
	_______, _______, _______, _______, _______, KC_NO, KC_NO, _______, KC_NO, _______, _______
  ),
/* Functions Layer
   * ,-----------------------------------------------------------------------------------------.
