...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = KEYMAP( \
        ...
        KC_LCTL,KC_A,ALT_T(KC_S),SFT_T(KC_D),CTL_T(KC_F),GUI_T(KC_G),GUI_T(KC_H),CTL_T(KC_J),SFT_T(KC_K),ALT_T(KC_L),   KC_SCLN,KC_QUOT,KC_NUHS,KC_ENT,      KC_HOME,\
        KC_LSFT,KC_NUBS,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_RSFT,     KC_UP,  KC_END,\
        KC_FN0,KC_LGUI,KC_LALT,             LT(_FL,KC_SPC)      ,           KC_RALT,KC_RCTL, KC_RCTL,     KC_LEFT,KC_DOWN,KC_RGHT \
    ),
    [_FL] = KEYMAP( \
        KC_ESC,KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12, KC_TRNS,KC_TRNS,KC_MUTE,\
